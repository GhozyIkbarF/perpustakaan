   ...
   require 'user_proses.php';
        if (isset($_POST['ubah'])){
            if(ubah($_POST) > 0){
	            ...
	            echo "<meta http-equiv='refresh' content='0; url=?page=profilset&id=$id'>";
   ...
   <!-- menu tengah -->
	<div style="background-color: #fff; padding: 15px; height:  655px;" id="menu-tengah">
    	<div id="bg_menu"><b>Edit Profil</b></div>
    	<div id="content_menu">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 15px;" action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="submit" name="ubah" value="ubah" class="btn btn-sm btn-primary">&nbsp;<a href="index.php" class="btn btn-sm btn-danger">Batal</a>
                                        </div>
                                    </div>
