<?php
   ...
   <!-- menu tengah -->
	<div style="background-color: #fff; padding: 15px; height:  655px;" id="menu-tengah">
    	<div id="bg_menu"><b>Transaksi</b></div><br>
    	<div id="content_menu">
        <div id="menu_header">
        	<form action="?page=transaksi_search" method="post">
        	<table width="100%">
            	<tr>
                	<td width="75%"><a class="btn btn-success" href="?page=transaksi_input">Input Transaksi</a></td>
                </tr>
   	    ...
   	    <div class="zebra-table">
            ...
            <?php
				session_start();
				$id = $_SESSION['id'];
				$query = "SELECT * FROM tbl_transaksi WHERE status='Pinjam' and nim='$id'";
