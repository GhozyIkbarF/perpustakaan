            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a title="Landing Page" href="?page=transaksiguest" aria-expanded="false">
                        ...
                        <li>
                            <a title="Landing Page" href="?page=lokasi" aria-expanded="false">
                                <span class="educate-icon  icon-wrap sub-icon-mg" aria-hidden="true"><i class="fas fa-map-marker-alt"></i></span> 
                                <span class="mini-click-non">Lokasi</span>
                            </a>
                        </li>
                    </ul>
                </nav>
